...
"")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/png/icons8-dot-24_live.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/icons/png/icons8-dot-24_red.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
    ...
    def retranslateUi(self, FrameCard):
        ...
        self.btn_addPlan.setText(_translate("FrameCard", "ON"))
import icons_rc
