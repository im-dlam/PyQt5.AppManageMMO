...
class ShadowFrame(QWidget):
    ...
    def __initUi(self):
        ...
        self.__effect.setBlurRadius(1.0)
        self.__effect.setColor(QColor(10, 10, 0, 127))
    ...
    def paintEvent(self, e):
        ...
        rect = rect.marginsRemoved(QMargins(0,0,0,0))
...
class MainWindow(QMainWindow):
    ...
    def __initUi(self):
        ...
        textEdit = QTextEdit()
        self.setStyleSheet("background-color:#002b80;")
        lay = QVBoxLayout()
        lay.addWidget(lbl)
