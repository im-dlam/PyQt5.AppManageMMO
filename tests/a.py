...
class Ui_Connect(QMainWindow):
    ...
    def show_ui(self, Ui):
        ...
        self.windows.setWindowFlags(Qt.FramelessWindowHint)
        ...
        self.windows.paintEvent = self.paintEvent  # Override paintEvent
    ...
    def paintEvent(self, event):
        painter = QPainter(self.windows)
        path = QPainterPath()
        path.setFillRule(Qt.WindingFill)
        path.addRoundedRect(0, 0, self.windows.width(), self.windows.height(), 10, 10)
